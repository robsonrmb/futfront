...
class UsuarioService {
  ...
  incluiFoto(var usuarioModel, {bool teste}) {
    if (teste == null || teste == false) {
  ...
  atualiza(var usuarioModel, {bool teste}) {
    if (teste == null || teste == false) {
  ...
  desativa(String idUsuario, {bool teste}) {
    if (teste == null || teste == false) {
  ...
  Future<UsuarioModel> buscaPorId(String idUsuario, {bool teste}) {
    String url = "${ConstantesRest.URL_USUARIOS}/${idUsuario}";
    UsuarioRest usuarioRest = UsuarioRest();
    return usuarioRest.processaHttpGetObject(url, teste);
  }

  Future<List<UsuarioModel>> listaTodos({bool teste}) async {
    String url = "${ConstantesRest.URL_USUARIOS}";
    UsuarioRest usuarioRest = UsuarioRest();
    return usuarioRest.processaHttpGetList(url, teste);
  }

  Future<List<UsuarioModel>> listaPorFiltros(var usuarioModel, {bool teste}) async {
    String url = "${ConstantesRest.URL_USUARIOS}/filter";
    UsuarioRest usuarioRest = UsuarioRest();
    return usuarioRest.processaHttpPostReturn(url, usuarioModel, teste);
  }
